...
public class CircleProgressBarView extends View {
     ...
     * 进度条背景颜色
     */
    private int circleBgColor = 0xFFFFFFFF;
    /**
     * 进度条颜色
     */
    ...
    public void getCurrentProgress(ValueAnimator.AnimatorUpdateListener listener) {
        progressAnimator.addUpdateListener(listener);
